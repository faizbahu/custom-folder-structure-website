    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg class="h-16 w-auto bg-gray-100 dark:bg-gray-900" fill="none" viewBox="0 0 62 65" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="mt-16">
                ...
                <div>
                    <form action="" class="max-w-fit mx-auto ">
                        ...
                        <a href="#">
                            <div class="w-fit mx-auto cursor-pointer mt-10 text-xl bg-red-500 hover:bg-red-700 text-white px-10 py-2 font-semibold rounded-md" data-modal-target="defaultModal"
                    ...
                    <div class="flex items-center gap-4">
                        <a class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                           href="https://github.com/sponsors/taylorotwell">
                            <svg class="-mt-px mr-1 w-5 h-5 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400" fill="none" stroke-width="1.5"
